    ...
    >
      ...
      >
        <div ref={slidesInnerRef} className="slides-inner flex h-full w-full">
          ...
          <div className="product-slide flex h-full w-full flex-shrink-0 items-center justify-center gap-6 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-[120px] px-4 sm:px-6 md:px-8 lg:px-10 py-4 sm:py-6 flex-col lg:flex-row">
            {/* Left Side - Preview Box */}
            <div className={`flex w-full lg:w-[596px] lg:h-[430px] h-[280px] sm:h-[320px] md:h-[360px] lg:h-[430px] shrink-0 items-center justify-center rounded-xl sm:rounded-2xl md:rounded-3xl border border-white/30 ${products[0].bgColor} p-3 sm:p-4 md:p-5`}>
              {/* Placeholder for preview */}
            </div>

            {/* Right Side - Content */}
            <div className="flex w-full lg:w-[500px] shrink-0 flex-col gap-4 sm:gap-5 md:gap-6">
              {/* Top Section - Badge, Title & Button */}
              <div className="flex flex-col gap-3 sm:gap-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full bg-[#0E4478]/40">
          ...
          <div className="product-slide flex h-full w-full flex-shrink-0 items-center justify-center gap-6 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-[120px] px-4 sm:px-6 md:px-8 lg:px-10 py-4 sm:py-6 flex-col lg:flex-row">
            {/* Left Side - Preview Box */}
            <div className={`flex w-full lg:w-[596px] lg:h-[430px] h-[280px] sm:h-[320px] md:h-[360px] lg:h-[430px] shrink-0 items-center justify-center rounded-xl sm:rounded-2xl md:rounded-3xl border border-white/30 ${products[1].bgColor} p-3 sm:p-4 md:p-5`}>
              {/* Placeholder for preview */}
            </div>
          ...
          {/* Slide 3 - Privacy */}
          <div className="product-slide relative flex h-full w-full flex-shrink-0 items-center justify-center gap-6 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-[120px] px-4 sm:px-6 md:px-8 lg:px-16 xl:px-[200px] py-6 sm:py-8 md:py-10 flex-col lg:flex-row">
            {/* Left Side - Heading */}
            ...
            <div className="relative z-10 flex w-full lg:w-[600px] shrink-0 flex-col gap-1 self-end pb-0 sm:pb-8 md:pb-12 lg:pb-[150px]">
              {/* Shield Icon - Absolute positioned with lower z-index and rotated */}
              <div className="absolute -right-4 sm:-right-8 md:-right-[50px] -top-8 sm:-top-12 md:-top-[60px] z-0 flex items-center justify-center rounded-full bg-[#67E4F9]/[0.08] p-4 sm:p-6 md:p-8 lg:p-10 rotate-[15deg]">
